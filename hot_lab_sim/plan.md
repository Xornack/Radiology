...
*Drafted 2026-07-15, based on regulatory + technical research and scoping decisions (custom web app; hot lab + camera QC content first, extensible; cheap personally-run cloud hosting; admin-created accounts with email login).*
...
- **Regulatory paper trail** — hour accounting mapped to 10 CFR 35.290 topics, exportable records, and (later) preceptor sign-off worksheets feeding NRC Form 313A(AUD).
...
- **Critical framing:** an on-screen simulator **cannot itself satisfy the supervised work-experience elements** (those require hands-on handling under an AU), but it legitimately delivers **classroom/laboratory hours** toward the 80 and serves as pre-lab preparation — exactly the NRC80 model (pre-lab video → hands-on in the program's own hot lab → data analysis worksheet, AU-signed).
...
| # | Module | Maps to | Content sources |
|---|--------|---------|-----------------|
| 1 | Radioactivity math & units | 35.290(c)(1)(i)(C) | Self-made videos + Rust/WASM decay demo; embedded calculation questions |
| 2 | Package receipt, surveys & wipe tests | (c)(1)(ii)(A); 20.1906 | Bolin/self videos; NUREG-1556 procedures |
| 3 | Dose calibrator QC (constancy, accuracy, linearity, geometry) | (c)(1)(ii)(B); 35.60 | Self videos; physicist linearity video when schedulable; data-analysis worksheet (enter readings → auto-check ±10%) |
| 4 | Survey meters & area surveys | (c)(1)(ii)(B); 35.61 | Videos + "which meter for which task" questions |
| 5 | Generator elution, Mo-99 breakthrough, kit prep | (c)(1)(ii)(G); 35.204 | Videos; breakthrough calculation activity (limit: 0.15 kBq/MBq) |
| 6 | Dose calculation, preparation & administration; written directives / medical-event prevention | (c)(1)(ii)(C),(D),(F) | Videos + scenario questions |
| 7 | Spills & decontamination | (c)(1)(ii)(E) | Video scenarios (minor vs major spill) |
| 8 | Waste: decay-in-storage & disposal | 35.92 | Videos |
| 9 | Gamma camera daily QC: uniformity floods | ACR NM accreditation | Videos + IAEA QC Atlas image bank: "normal or artifact?" image questions |
| 10 | Camera resolution/linearity, COR, SPECT phantom, SPECT/CT QC | ACR | Videos (physicist tests when schedulable) + atlas images |
...
- Exports: CSV of completion records; per-resident PDF training summary (topics, dates, hours, instructor) formatted to transcribe onto Form 313A(AUD).
...
| Ads on third-party (Bolin) videos | Prefer re-uploading to our own non-monetized unlisted channel (permission already granted); use originals only where re-upload isn't possible |
| iOS Safari player bugs | Spike in Phase 0 before building on top; h5p-standalone fallback |
| Physicist linearity/COR videos hard to schedule | Modules 3 & 10 launch with atlas images + our own footage; physicist footage slots in when filmed — content model supports updating lessons with version bump |
...
- NUREG-1556 Vol. 9 model procedures — https://scp.nrc.gov/narmtoolbox/nureg1556vol9_rev2_012408.pdf
